  ...
  return (
    <main className="flex min-h-screen w-full h-screen">
      <div className={'flex flex-row w-full h-full'}>
          <div className={'w-[241px] bg-black flex-col flex justify-between items-start h-full pb-[32px] p-[24.82px]'}>
          ...
          <div className={'w-full flex flex-col z-30  h-[100%]  bg1'}>
              <div className={'z-20 px-[32px] pt-[88px]'}>
                  ...
                  <div className={'flex flex-row mt-[22px] w-full gap-[24px]'}>
                      <div className={'w-[207px] transition-all duration-400  group p-[16px] cursor-pointer hover:h-full h-[298px] overflow-hidden bg-[#181818] rounded-[6px]'}>
